...
class SepPage{
	...
	function ShowPage($contentname,$utits,$anothersearchstr,$anothersearchstrs,$class){
		...
		$str.="&nbsp;&nbsp;&nbsp;&nbsp;";
		if($this->nowpage!=1)
			$str.="<a href=".$_SERVER['PHP_SELF']."?page=1&class_title=".$anothersearchstr."&parameter2=".$anothersearchstrs." class=".$class.">首页</a>";
		else
			$str.="<font color='#555555'>首页</font>";
		$str.="&nbsp;";
		if($this->nowpage!=1)
			$str.="<a href=".$_SERVER['PHP_SELF']."?page=".($this->nowpage-1)."&class_title=".$anothersearchstr."&parameter2=".$anothersearchstrs." class=".$class.">上一页</a>";
		else
			$str.="<font color='#555555'>上一页</font>";
		$str.="&nbsp;";	
		if($this->nowpage!=$pagecount)
			$str.="<a href=".$_SERVER['PHP_SELF']."?page=".($this->nowpage+1)."&class_title=".$anothersearchstr."&parameter2=".$anothersearchstrs." class=".$class.">下一页</a>";
		else
			$str.="<font color='#555555'>下一页</font>";	
		$str.="&nbsp;";
		if($this->nowpage!=$pagecount)
			$str.="<a href=".$_SERVER['PHP_SELF']."?page=".$pagecount."&class_title=".$anothersearchstr."&parameter2=".$anothersearchstrs." class=".$class.">尾页</a>";
		else
